...
<input type="hidden" id="prdtNo" value="${b.prdt_code}">  
		<div class="ec-base-button ">
            <span class="gLeft">
                ...
                <a onclick="goList()" class="yg_btn_30 yg_btn4" alt="목록">LIST</a>
            </span>
            <span class="gRight">
...
function updateQnA(){
	...
	location.href="delivery_board_update1.do?qna_no="+qna_no;
};

function deleteQnA(){
	var prdtNo = $('#prdtNo').val()
	var qna_no = $('#qq_no').val()
	location.href="delivery_board_delete1.do?qna_no="+qna_no+"&prdtNo="+prdtNo;
};
