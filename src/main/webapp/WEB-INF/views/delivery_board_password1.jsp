...
<div class="secret">            
            <fieldset>
                ...
                <div class="ec-base-button gBlank30">
                    <button onclick="goList()" class="yg_btn_140 yg_btn3" alt="목록">LIST</button>
...
<input type="hidden" id="prdtNo" value="<%=prdtNo %>">
 ...
 function goList(){
	...
	function passwordCheck(){
		...
		$.ajax({
			url:"passwordCheck1.do",
			data : {qna_no : qna_no , password : password},
			success : function(data){
				if(data =="ok"){
					location.href="delivery_board_detail1.do?qna_no="+qna_no;
				}else{
					alert("비밀번호를 확인해 주세요");
				}
			},
