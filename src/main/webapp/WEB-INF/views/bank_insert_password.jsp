        ...
        <div id="contents" style="margin-top:11.5%; margin-bottom:12.5%;">
         ...
         <div class="titleArea">
             <h2 style="display: inline-block;
   				 ...
   				 font-weight: 400;
    			letter-spacing: 2px;
    			margin-left: 43.8%;">입금확인/입금자변경</h2>
         </div>
...
<div class="secret">            
            <fieldset>
                ...
                <div class="ec-base-button gBlank30">
                    <a href="bank_insert_board.do" class="yg_btn_140 yg_btn3" alt="목록">LIST</a>
	...
	function passwordCheck(){
		...
		$.ajax({
			...
			success : function(data){
				if(data =="ok"){
					location.href="bank_insert_detail.do?qna_no="+qna_no;
				}else{
					alert("비밀번호를 확인해 주세요");
				}
			},
