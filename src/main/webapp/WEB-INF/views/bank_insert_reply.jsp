...
배송이 바로 가능한가요?
	...
	<tbody>
		...
		<div class="ec-base-button ">
            ...
            <span class="gRight">
                <a href="bank_insert_board.do" onclick="BOARD_WRITE.form_submit('boardWriteForm');" class="yg_btn_30 yg_btn4" alt="등록">UPDATE</a>
                <a href="bank_insert_board.do" class="yg_btn_30 yg_btn4" alt="취소">DELETE</a>
            </span>
        </div>
	</div>
</form>
