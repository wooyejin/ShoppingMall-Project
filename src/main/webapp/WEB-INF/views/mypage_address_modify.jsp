...
<body>
	...
	<div id="container">
		...
		<div id="contents">
			...
			<form id="frmAddr" name="" action="AddressUpdate.do">
				...
				<div class="xans-element- xans-myshop xans-myshop-addrmodify ">
								...
								<tr>
				                    ...
				                    <td>
				                    	<input id="adTitle" name="adTitle" 
				                    	 class="inputTypeText" value="${ad.adTitle}" type="text">
				                    </td>
				                </tr>
								...
								<tr>
		                    		...
		                    		<td>
		                    			<input id="adReceiver" name="adReceiver"
		                     			 class="ec-member-name" value="${ad.adReceiver }" type="text">
		                   			 </td>
		               			</tr>
					...
					<div class="ec-base-button">
		       			<span>
				            <a href="#none" class="yg_btn_140 yg_btn5" onclick="AddressUpdate();" alt="수정">수정</a>
