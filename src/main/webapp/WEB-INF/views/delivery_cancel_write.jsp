...
<form id="boardWriteForm" action="delivery_cancel_insert.do" method="post" enctype="multipart/form-data">
	...
	<tr>
		<th scope="row">SUBJECT</th>
           <td><select id="subject" name="b_cate_no">
			<option value="3">[배송전 주문취소/변경]</option>
			</select>  	
		   </td>
    </tr>
	...
	<tbody>
		...
		<div class="ec-base-button ">
            ...
            <span class="gRight">
                <button  id="dc_insert_ok" class="yg_btn_30 yg_btn4" alt="등록">OK</button>
                <a href="delivery_cancel.do" class="yg_btn_30 yg_btn4" alt="취소">CANCEL</a>
            </span>
        </div>
	</div>
</form>
