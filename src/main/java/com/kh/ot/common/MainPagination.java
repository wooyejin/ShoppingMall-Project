...
public class MainPagination {
	...
	public static MainPageInfo getPageInfo(int currentPage, int listCount) {
		
		// 페이지 정보를 담아줄 PageInfo 참조변수 선언
		MainPageInfo mainPi = null;
		...
		int boardLimit = 12; 	// 한 페이지에 보여질 게시글 갯수
		...
		mainPi = new MainPageInfo(currentPage, listCount, pageLimit, maxPage,startPage,endPage, boardLimit);
		
		return mainPi;
	}
	
public static MainPageInfo getPageInfo2(int currentPage, int listCount) {
		...
		int boardLimit = 20; 	// 한 페이지에 보여질 게시글 갯수
